                ...
                <dir class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <p class="text-center">SMA Negeri 77 Lampung</p>
                            @if (Auth::guest())
                                <p class="text-center"> Untuk dapat menggunakan aplikasi ini silahkan <a
                                        href="{{ url('/login') }}">login</a> terlebih dahulu!</p>
                            @endif
                            </p>
                        </div>
                    </div>
